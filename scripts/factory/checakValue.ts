...
async function main() {
  ...
  const p12Factory = await P12FACTORY.attach(
  ...
  console.log('uniswap router address', await p12Factory.uniswapRouter());
  console.log('uniswap factory address', await p12Factory.uniswapFactory());
}
